...
from .models import Metadatas, ContactDetails, ContactMessage, Footer, Work, Whoweare, Blog, About, Resume
...
def profile(request):
	...
	return render(request, 'profile.html', {'Homemessage':ProfileHome, 'Foot':ProfileFooter, 'Metadat':Profilemeta, 'Profiles':Resume})
